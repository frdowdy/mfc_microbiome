---
title: "MFC Microbiome Git Notebook"
output:
  html_document:
    toc: yes
...
```{r Networks in Bristle and Planktonic Samples}
...
#filter OTU's to 50% presence in all samples
  ...
  #run co-occurence. Taxon can be excluded and identified later if desired.
  biom_netw_bristles=cooccurrence(data = biom_fil_bristles,taxon = biom$taxon,type="sp",cor=.6,pval=.05)
